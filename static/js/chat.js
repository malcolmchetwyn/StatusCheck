...
async function sendMessage() {
    ...
    aiMessageDiv.innerHTML = '<strong>Compassionate Guide:</strong> <em>Typing...</em>';
    ...
    try {
        ...
        while (true) {
            ...
            aiMessageDiv.innerHTML = '<strong>Compassionate Guide:</strong> ' + html;

            // Scroll to the bottom as new content arrives
            chatBox.scrollTop = chatBox.scrollHeight;
        }
    } catch (error) {
        aiMessageDiv.innerHTML = '<strong>Compassionate Guide:</strong> [Error] ' + error.message;
    }
}
